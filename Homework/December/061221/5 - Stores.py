...
for i in range(len(store[goods["Стол"]])):
    table_kol += store[goods["Стол"]][i]['quantity']     # Счёт кол-ва
    table_cost += store[goods["Стол"]][i]['quantity'] * store[goods["Стол"]][i]['price']    # Счёт стоимости
...
for i in range(len(store[goods["Диван"]])):
    sofa_kol += store[goods["Диван"]][i]['quantity']   # Счёт кол-ва
    sofa_cost += store[goods["Диван"]][i]['quantity'] * store[goods["Диван"]][i]['price']   # Счёт стоимости
...
for i in range(len(store[goods["Стул"]])):
    chair_kol += store[goods["Стул"]][i]['quantity']  # Счёт кол-ва
    chair_cost += store[goods["Стул"]][i]['quantity'] * store[goods["Стул"]][i]['price']  # Счёт стоимости
